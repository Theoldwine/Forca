...
while ativo == 0:
    ...
    if tema in list1:
        ...
        print('Erro! O valor digitado não é um número de 1 a 6')
        continue
    tema = int(tema)
    ativo2 = 0
    ...
    while ativo2 == 0:
        ...
        if tema == 1:
            ...
            if subtema in list2:
                ...
                print('Erro! O valor digitado não é um número de 1 a 4')
                continue
            subtema = int(subtema)
